...
#define COCOAPODS_POD_AVAILABLE_BAHFourCornersController
#define COCOAPODS_VERSION_MAJOR_BAHFourCornersController 0
#define COCOAPODS_VERSION_MINOR_BAHFourCornersController 1
#define COCOAPODS_VERSION_PATCH_BAHFourCornersController 0

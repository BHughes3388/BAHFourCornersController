//
//  BAHDemoTopLeftViewController.m
...
@interface BAHDemoTopLeftViewController ()

@end

@implementation BAHDemoTopLeftViewController
...
- (void)viewDidAppear:(BOOL)animated{
    ...
    if (self.view.subviews.count < 1) {
        ...
        title.autoresizingMask = UIViewAutoresizingFlexibleBottomMargin | UIViewAutoresizingFlexibleLeftMargin | UIViewAutoresizingFlexibleRightMargin;
        ...
        [subtitle setText:@"Top Left ViewController"];

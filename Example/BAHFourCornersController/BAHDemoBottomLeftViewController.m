//
//  BAHDemoBottomLeftViewController.m
...
@interface BAHDemoBottomLeftViewController ()

@end

@implementation BAHDemoBottomLeftViewController
...
- (void)viewDidAppear:(BOOL)animated{
    ...
    if (self.view.subviews.count < 1) {
        ...
        [titleLabel setText:@"Bottom Left"];
        ...
        [subtitle setText:@"Bottom Left ViewController"];
